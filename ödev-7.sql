...
FROM film
GROUP BY rating; 
-- Result : 5 farklı rating değerinden film tablosunda kaç adet olduğu gruplanmıştır. (EX:NC-17 rating değeri 210 tanedir.)
...
GROUP BY country_id
ORDER BY COUNT(*) DESC
FETCH FIRST 1 ROW ONLY; -- FETCH YERINE LIMIT 1 YAZILABİLİR.